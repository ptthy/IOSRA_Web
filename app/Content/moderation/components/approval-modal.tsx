          ...
          >
            ...
            <div className="p-4 space-y-4">
              <p className="text-gray-600 dark:text-gray-400 text-xs leading-relaxed">
                Vui lòng chọn hoặc nhập <strong>lý do phê duyệt</strong>.
              </p>
                  ...
                  {commonReasons.map((commonReason, index) => (
                    <button
                      ...
                      className={`w-full text-left p-2 rounded-lg border text-xs transition-all ${
                        reason === commonReason
                          ? "border-green-500 bg-green-50 dark:bg-green-900/30 text-gray-900 dark:text-green-300 shadow-sm"
                          : "border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:border-green-300 dark:hover:border-green-500/50 hover:bg-gray-50 dark:hover:bg-gray-700"
                      }`}
                    >
                      {commonReason}
                    </button>
              ...
              <div>
                ...
                <Textarea
                  ...
                  disabled={isSubmitting}
                  className="min-h-[90px] text-sm bg-white dark:bg-gray-900 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white focus:ring-green-500 focus:border-green-500"
                />
              </div>
            </div>
            ...
            <div className="flex items-center justify-end gap-2 p-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/40 rounded-b-xl">
              ...
              <Button
                className="h-8 px-3 text-xs bg-green-600 hover:bg-green-700 text-white disabled:bg-green-400"
