...
//           {/* Center: Voice Controls - Clean & Compact */}
//           <div className="flex items-center gap-2">
//             {/* Play/Pause */}
//             <Button
//               size="icon"
//               className="h-9 w-9 rounded-full shadow-sm transition-all hover:scale-105"
//               style={{
...
//                 size="sm"
//                 onClick={() => skipTime(-10)}
//                 className="h-7 px-2 rounded-md text-xs font-medium"
//                 style={{ color: colors.text }}
//               >
//                 -10s
//               </Button>
...
//               >
//                 <SelectTrigger
//                   className="w-[60px] h-8 text-xs border rounded-lg"
//                   style={{
...
//               >
//                 <SelectTrigger
//                   className="w-[95px] h-8 text-xs border rounded-lg"
//                   style={{
//                     borderColor: colors.border,
//                     color: colors.text,
//                   }}
